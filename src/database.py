...
def database_connection_url():
    dotenv.load_dotenv()
    DB_USER: str = os.environ.get("STAGING_POSTGRES_USER")
    DB_PASSWD = os.environ.get("STAGING_POSTGRES_PASSWORD")
    DB_SERVER: str = os.environ.get("STAGING_POSTGRES_SERVER")
    DB_PORT: str = os.environ.get("STAGING_POSTGRES_PORT")
    DB_NAME: str = os.environ.get("STAGING_POSTGRES_DB")
